                ...
                <div class="sorting">
                    <div class="sorting__row">
                        <div class="sorting__col">
                            <div class="products__title h6 mobile-hide">Edit Member</div>
                            ...
                            <div class="showFlex">
                                <div class="itemFlex">
                                    ...
                                    <div class="field__wrap">
                                        <input class="field__input" name="firstName" type="text" placeholder="Name" value="{{ $course->firstName }}">
                                    </div>
                                </div>
                                <div class="itemFlex">
                                    <div class="field__label">Surname</div>
                                    <div class="field__wrap">
                                        <input class="field__input" name="lastName" type="text" placeholder="Surname" value="{{ $course->lastName }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="field__wrap">
                                    <input class="field__input" name="email" type="email" placeholder="mail@mail.com" value="{{ $course->email }}" readonly>
                                </div>
                                ...
                                <div class="showFlex ">
                                    ...
                                    <div class="itemFlex">
                                        ...
                                        <div class="field__wrap">
                                            <input class="field__input" name="password_confirmation" type="password" placeholder="Retype Password">
                                        </div>
                                    </div>
                                </div>
                                <small class="text-gray">Leave blank if you don't want to change the password.</small>
                                </div>
                                                ...
                                                <select class="field__input" name="role">
                                                    ...
                                                    @isset($Role)
                                                        @foreach ($Role as $item)
                                                            <option value="{{ $item->id }}" {{ old('role', $course->roles->first()->id ?? '') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    @endisset
                                                ...
                                                <select class="field__input" name="country">
                                                    @isset($countries)
                                                        @foreach ($countries as $item)
                                                            <option value="{{ $item->id }}" {{ old('country', $course->country ?? '') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    @endisset
                            ...
                            <div class="itemFlex">
                                <div class="image-upload-container">
                                    <div class="image-preview" id="imagePreview" style="height: 300px; border-radius: 100%;">
                                        <img id="previewImage" src="{{ $course->avatar ?? url('img/300-1.jpg') }}" alt="Preview">

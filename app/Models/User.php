...
class User extends Authenticatable implements JWTSubject
{
     ...
     */
    protected $fillable = [
        'name', 'country', 'firstName', 'lastName', 'email', 'position', 'userType', 'terms', 'prefix', 'vetId', 'clinic', 'password', 'email_verified_at', 'is_admin', 'provider', 'provider_id', 'access_token', 'avatar', 'phone', 'address', 'birthday', 'zipcode', 'point', 'idcard', 'code_user', 'shop_id',
    ];
